...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/ha_r_sh15/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/ha_r_sh15/", "_blank");
    }
    if (x == 3) {
        window.open("file:///C:/Users/HARSH/OneDrive/Desktop/HTML/Portfolio.html", "_blank");
    }
}